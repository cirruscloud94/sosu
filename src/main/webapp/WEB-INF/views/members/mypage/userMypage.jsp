...
<div class="container" style="text-align:center">
   <h1 style="margin-top:50px; margin-bottom:40px">${mypageInfo[0][0].M_NICKNAME}'S PAGE</h1>
    ...
    <p class="nickname">${mypageInfo[0][0].M_NICKNAME}
		...
		<!-- 쪽지 -->
		<span><a href="/members/mypagemodifyform.sosu"><img class="img-modi" src="/resources/img/icons/mail.png"></a></span> 
		<!-- 신고 -->
   ...
   <form action="/members/usermypage.sosu" method="get">
	...
	<div class="row gy-5">
      <!-- 해당 회원이 비공개 처리 했을 경우  -->
      <c:if test="${privateCheck eq '1' || privateCheck eq '2'}"><div class="onlyMyPrivate">비공개입니다.</div></c:if>
   ...
   <c:if test="${mypageCategory eq '4' }">
	   ...
	   <!-- 비공개 처리했을 경우 -->
	      <c:if test="${privateCheck eq '1' || privateCheck eq '3'}"><div>비공개입니다.</div></c:if>
	   <!-- 비공개 처리 안한 경우 -->
