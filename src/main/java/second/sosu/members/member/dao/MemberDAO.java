...
public class MemberDAO extends AbstractDAO {
	...
	public List<List<Map<String, Object>>> mypage(Map<String, Object> map) throws Exception {
		...
		for (int i = 0; i < mypageInfo.get(3).size(); i++) {
			Map<String, Object> openMoimMember = (Map<String, Object>) selectOne("members.mypageMoimMember",
					mypageInfo.get(3).get(i).get("MO_IDX"));
		...
		for (int i = 0; i < mypageInfo.get(4).size(); i++) {
			Map<String, Object> partyMoimMember = (Map<String, Object>) selectOne("members.mypageMoimMember",
					mypageInfo.get(4).get(i).get("MO_IDX"));
		...
		for (int i = 0; i < mypageInfo.get(7).size(); i++) {
			Map<String, Object> partyMoimMember = (Map<String, Object>) selectOne("members.mypageMoimMember",
					mypageInfo.get(7).get(i).get("MO_IDX"));
...
//       }
	...
	// 프로필 체크
	@SuppressWarnings("unchecked")
	public List<Map<String, Object>> mypagePartyMoim(Map<String, Object> map) throws Exception {

		return (List<Map<String, Object>>) selectList("members.mypagePartyMoim", map);
	}
	...
	public List<Map<String, Object>> adminMemberReport(Map<String, Object> map) throws Exception {
		...
		for (int i = 0; i < reportMap.size(); i++) {
			...
			List<Map<String, Object>> list = (List<Map<String, Object>>) selectList("members.adminMemberDetail",
					m.get("M_IDX"));
